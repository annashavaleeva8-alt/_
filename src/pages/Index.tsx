      ...
      <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            Меня зовут <strong className="text-foreground">Шавалеева Алина Рустемовна</strong>. Я — Ведущий врач-офтальмолог, ортокератолог, принимаю пациентов всех возрастов, включая новорождённых. Работаю в Москве и специализируюсь на детской и взрослой офтальмологии.
          </p>
          <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <div className="mb-6">
            <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-2">Повышение квалификации</h3>
            <ul className="text-muted-foreground text-sm leading-relaxed space-y-1">
